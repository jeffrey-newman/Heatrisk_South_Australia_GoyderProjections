...
for time_series in data_files:
    ...
    if (time_series[2] == "csiro.mk36"):
        this_stats = calcEHF_recalc(time_series[0], filename, time_series[5], t95_avg_vals[time_series[2]][time_series[3]][time_series[4]])
...
with open('stat_vals.pickle', 'wb') as f3:
    # Pickle the 'data' dictionary using the highest protocol available.
